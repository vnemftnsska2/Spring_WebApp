  ...
  <body class="skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="/sboard/home" class="logo">
          <!-- mini logo for sidebar mini 50x50 pixels -->
          <span class="logo-mini"><b>A</b>LT</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>순남2 PROJECT</b></span>
        </a>
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="/resources/dist/img/logo.jpg" class="user-image" alt="User Image"/>
                  <span class="hidden-xs">순남2</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="/resources/dist/img/logo.jpg" class="img-circle" alt="User Image" />
                    <p>
                      순남2 - Web Developer
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="/user/signOut" class="btn btn-default btn-flat">Log Out</a>
                    </div>
                  </li>
                </ul>
              </li>
